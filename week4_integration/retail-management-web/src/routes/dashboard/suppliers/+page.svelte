...
<div class="selaincategory">
    <div class="atas">
        <div class="ataskiri">  
            ...
            <h2 style="margin:5px 0 0 0; font-size: 18px; color: gray;"><strong>KAMU ADALAH,</strong> [roles]</h2>
        </div>
        <div class="ataskanan">
    ...
    <div class="bawah">
        <div class="produk">
            <p class="productname">Suppliers Name</p>
...
<div class="popupadd">   
    <div class="namapopup">
        ...
        <h2><strong>Insert New Suppliers</strong></h2>
...
<div class="popupupdate">   
    <div class="namapopup">
        <button class="closepopup">X</button>
        <h2><strong>Suppliers Name</strong></h2>
